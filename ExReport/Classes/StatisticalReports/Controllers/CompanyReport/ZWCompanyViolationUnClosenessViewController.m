//
//  ZWCompanyViolationUnClosenessViewController.m
//  Muck
//
...
@interface ZWCompanyViolationUnClosenessViewController ()
<UITableViewDelegate,
...
@implementation ZWCompanyViolationUnClosenessViewController
...
- (void)viewDidLoad {
    ...
    if (self.controllerType == ZWCompanyViolationUnClosenessViewControllerUnClosenessRateMost) {
        self.OrderBy = 1;
        [self setupNavigationTitleWithTitle:@"未密闭率最高企业"];
    }else{
        self.OrderBy = 2;
        [self setupNavigationTitleWithTitle:@"未密闭率最低企业"];
    }
...
//    ZWAreaViolationRankModel *rankModel = cell.rankModel;
//    ZWCompanyBasicInfoViewController *vc = [[ZWCompanyBasicInfoViewController alloc]init];
//    vc.Type = self.Type;
//    vc.BeginDate = self.BeginDate;
//    vc.EndDate = self.EndDate;
//    vc.EnterpriseName = rankModel.EnterpriseName;
//    vc.EnterpriseId =  @[cell.rankModel.Id];
