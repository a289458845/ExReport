//
//  ZWCompanyDetailAllViewController.m
//  Muck
//
...
@interface ZWCompanyDetailAllViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation ZWCompanyDetailAllViewController
