//
//  ZWCompanyDetailUnClosenessViewController.m
//  Muck
//
...
@interface ZWCompanyDetailUnClosenessViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation ZWCompanyDetailUnClosenessViewController
