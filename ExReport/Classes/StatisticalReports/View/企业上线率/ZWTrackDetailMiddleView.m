...
- (void)setModel:(ZWHisLocStatModel *)model
{
    ...
    self.frame = CGRectMake(0, kScreenHeight-kWidth(360-26*2)-ExNavigationHeight-H1-H2-ExSafeAreaBottom, kScreenWidth, kWidth(360-26*2)+H1+H2+ExSafeAreaBottom);
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        self.frame = CGRectMake(0, kScreenHeight-ExNavigationHeight-kWidth(360-26*2)-ExSafeAreaBottom, kScreenWidth, kWidth(360-26*2-88)+ExSafeAreaBottom);
...
- (void)disMiss{
    [UIView animateWithDuration:0.7 animations:^{
        self.frame = CGRectMake(0, kScreenHeight, kScreenWidth, kWidth(360-26*2-88)+ExSafeAreaBottom);
    }completion:^(BOOL finished) {
        self.hidden = YES;
    }];    
}
