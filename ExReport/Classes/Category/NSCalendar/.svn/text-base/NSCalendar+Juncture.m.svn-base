...
#pragma mark - First/Last of Year

- (NSDate *)firstDayOfTheYear
{
    return  [self firstDayOfTheYearUsingReferenceDate:[NSDate date]];
}

- (NSDate *)firstDayOfTheYearUsingReferenceDate:(NSDate *)date
{
    NSDateComponents *c = [self components: NSCalendarUnitYear fromDate:date];
...
{
    return [self lastDayOfTheYearUsingReferenceDate:[NSDate date]];
}

- (NSDate *)lastDayOfTheYearUsingReferenceDate:(NSDate *)date
{
    NSDateComponents *c = [self components: NSCalendarUnitYear fromDate:date];
    
    [c setDay:[self daysPerYearUsingReferenceDate:date]];
